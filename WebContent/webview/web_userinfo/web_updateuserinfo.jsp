...
<div class="layui-layout layui-layout-admin">
 <form class="layui-form" action="${pageContext.request.contextPath}/updateUserByiId.do" id="form1" name="form1" method="post" onsubmit="return validateForm()">
														...
														<div class="layui-card-body">
															<div class="layui-form-item">
																...
																<div class="layui-input-block">
																	<input type="text" name="user_phone" id="user_phone" requre lay-verify="user_phone" value="${userInfo1.user_phone}"
															...
															<div class="layui-form-item">
																...
																<div class="layui-input-block">
																	<input type="text" name="user_name"  id="user_name"  value="${userInfo1.user_name}"
																		class="layui-input">
																    <input type="hidden" name="id"  id="id"  value="${userInfo1.id}">
																</div>
															 </div>
															 <div class="layui-form-item">
																<label class="layui-form-label">登录级别</label>
																<div class="layui-input-block">
																   ${userInfo1.user_level}
																	<%-- <select name="user_level" requre lay-filter="user_level" >
																		<option value="管理员" ${userInfo1.user_level=="管理员"?'selected="selected"':''}>管理员</option>
																		<option value="用户"  ${userInfo1.user_level=="用户"?'selected="selected"':''}>用户</option>
																	</select> --%>
																</div>
											                   </div>
														</div>
													...
													<div class="layui-card">
														...
														<div class="layui-card-body">
														    <div class="layui-form-item">
																...
																<div class="layui-input-block">
																	<input type="password" name="user_pwd" id="user_pwd" value="${userInfo1.user_pwd}"
