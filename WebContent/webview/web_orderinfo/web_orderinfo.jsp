...
<body>
	<div>
		...
		<div class="listbiaoti am-cf">
         ...
         <br/>
           <c:if test="${type=='管理员'}">
		    <form class="am-form am-g" method="post"  name="form"  action="${pageContext.request.contextPath}/queryOrderInfoByUserName.do">
		     <div class="layui-form-item" style="margin-left:2%;">
			  <div class="layui-input-inline">
				<input type="text" name="userName" id="userName"
					 placeholder="请输入姓名" autocomplete="off" value="${userName}"
					class="layui-input"  >
			  </div>
						...
						<td>
							<div class="am-btn-toolbar">
								<div class="am-btn-group am-btn-group-xs">
								     <a href="${pageContext.request.contextPath}/getOrderInfoByOrderId.do?orderId=${item.id}"
